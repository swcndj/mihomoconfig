...
// 目标地区代码集合：仅用于筛选，重命名直接使用 countryCode 本身
const TARGET_COUNTRY_CODES = new Set(['HK', 'TW', 'JP', 'KR', 'SG', 'US']);
...
const DEBUG_BATCH = false; // 详细调试日志开关
// -------------------------------------------------- 配置区 --------------------------------------------------
...
// 批量查询IP的国家代码，返回 Map<ip, countryCode|null>
